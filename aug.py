...
def app():
    ...
    image1='https://editor.analyticsvidhya.com/uploads/25366Convolutional_Neural_Network_to_identify_the_image_of_a_bird.png'
    ...
    if buttonstat:
        ...
        if uploaded_file is not None:
            ...
            with tempfile.NamedTemporaryFile(delete=False) as tmp_file:
                ...
                url = 'https://damg7245-assignment03-api-xd232aklcq-uc.a.run.app/predict_with_augmented_data_trained_model'
                headers = {}
